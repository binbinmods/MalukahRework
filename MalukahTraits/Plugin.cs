...
namespace Malukah
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Malukah";
        public static string heroName = characterName;

        public static string subclassName = "Voodoowitch"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Malukah Rework",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/MalukahRework",
                _contentFolder: "Malukah",
